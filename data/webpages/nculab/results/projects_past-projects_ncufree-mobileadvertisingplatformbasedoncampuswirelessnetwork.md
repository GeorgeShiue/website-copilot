...
![NCUFree Poster](https://lh3.googleusercontent.com/sitesv/AG8ngQWNWSbWQstO77d2DVZFBOIFVuHpbLeSp8D5wx5DDJ0YbBtr15SW9K9IplyF8N0920mBV1H8s9PX7BU-mkuhEiwUVC9njVuFga09SEyIYOiiLZ7hP0vaDVfm3gbamM29jaKcaTakOja4GXe0ijDGwqy9vOx7Fql_T_uUGSIl5-uQ1-_Y2vPS0-oBrvRhYTH_pB70KLw6VA=w1280)
> # Image-1
>
> **圖片摘要：**
> NCUFree中大校園無線網路宣傳海報，上方設置Android與iOS系統APP下載QR Code，下方列出連線使用步驟與人才培育計畫標誌。
>
> **主要元素：**
> 1. 實體: NCUFree, 中大校園, QR Code, Android APP, iOS APP
> 2. OCR文字:
> NCUFree
> 中大校園走透透......
> 免費無線網路
...
> 提供具有SIM卡的裝置登入
> 僅限中大計中帳號登入
> 請先至 Google Play 或 Apple Store 下載NCUFree APP
> 開啟Wi-Fi，點選NCUFree無線網路，取消[自動登入]
> 確認連接NCUFree無線網路
> 開啟NCUFree APP，點擊APP內的NCUFree圖示，進行登入
> 人才培育計畫
> 提升校園行動應用服務研發及內容設計人才培育計畫
> Wi Fi
> 3. 主題標籤: 無線網路, 校園網路, 行動應用, NCUFree, 人才培育計畫
>
> **頁面關聯：**
> 本圖為NCUFree服務宣傳海報，屬於國立中央大學人才培育計畫之校園無線網路存取說明。
中央大學免費無線網路APP 本計畫由教育部推廣4G創新應用服務所贊助，為資工系WIDM實驗室所開發。本計畫提供具有SIM卡的裝置或中大計中帳號（其他系統iTaiwan或TANetRomaing帳號請連線NCUWL）的使用者，透過NCUFree APP登入使用，希望可提供校園訪客及校內生師快速連線無線網路。

![](https://lh3.googleusercontent.com/sitesv/AG8ngQUQ6nnyUlzWJ74WvIJyZ-2u7fzqqkA892c0Z9keUuOfRUvqHv5n4DGHby5qKsPMi_PEu4LzjqjmR4D3XBPUhIOULJdC2pHU6fRhI9CAm0W7ZZiMHywAaQe4RPMzQy8ctN2rkYPZ9S4JSlMGovNs8tKK4HcHS408=w1280)
> # Image-2
>
> **圖片摘要：**
> 白色三角形播放符號置於黑色圓角矩形中央，下方排列英文文字。
>
> **主要元素：**
> 1. 實體: Google Play, 播放符號
> 2. OCR文字:
> ANDROID APP ON
> Google play
> 3. 主題標籤: 數位發布平台, 行動應用程式, Google, 軟體下載
>
> **頁面關聯：**
> 圖片為 Google Play 平台下載連結，用於導向應用程式下載頁面。
[![](https://lh3.googleusercontent.com/sitesv/AG8ngQW_SNr_FiS5l8IDQDHBbBbndxT6s2ZCyOZSzGbmaGLnlQCLfCibr-emgEhdQQtWZbuNQtQ6J_S-oJS94V1NJzTFPnZauEKSARGxmR3huJ09g8v9eW3zN6TVU9H1VX1xmb25Y0TsFcbMG0CDYy-vKvUBrD7uqG9u=w1280)
> # Image-3
>
> **圖片摘要：**
> Apple標誌位於文字上方，文字標示應用程式獲取來源。
>
> **主要元素：**
> 1. 實體: Apple標誌, App Store
> 2. OCR文字:
> Available on the
> App Store
> 3. 主題標籤: Apple, 應用程式下載, 軟體發行
>
> **頁面關聯：**
> 屬於App Store連結，用於引導使用者下載應用程式。
](https://www.google.com/url?q=https%3A%2F%2Fappsto.re%2Ftw%2Fvj5Dfb.i&sa=D&sntz=1&usg=AOvVaw3_r8jw93ZN1gtqCk2zrgt1) [NCUFree 安裝暨使用方法](http://www.google.com/url?q=http%3A%2F%2Fncufree.widm.csie.ncu.edu.tw%2FNCufree_V2%2FDefault.aspx&sa=D&sntz=1&usg=AOvVaw2be2dwHOIvCx0POaRkGHG4)