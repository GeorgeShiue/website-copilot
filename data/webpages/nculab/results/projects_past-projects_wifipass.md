...
![](https://sites.google.com/sitesv-images-rt/AMxu72s3cPQz1DQ_bnAmoX8pg9PcZe-LSQTOh0A-DHwpnPm3cw0e7oiuOe2ppTOTO8vnHflweiJmUnpu7V4q4lg2gZbR6J2p8XBV8fD8xUPNG6aOPuEgtUPCrslCxD0EWOE2_dd3PhX_h2_6xdnFiaCYPs4B0qa11FivWYUOLTDPn9DYrQkWdRh0EM4xKn2_LoExupUzjjM3oDC_=w1280)
> # Image-1
>
> **圖片摘要：**
> WIDM lab 的 Wi-Fi登入通應用程式頁面，展示圖示與三張 Wi-Fi 功能截圖。
>
> **主要元素：**
> 1. 實體: Wi-Fi登入通, Wi-Fi Pass, WIDM lab, TANetRoaming, NCULW
> 2. OCR文字: Wi-Fi登入通 (Wi-Fi Pass)
> WIDM lab
> Tools
> 3+
...
> User Login
> username
> 3. 主題標籤: Wi-Fi登入通, Wi-Fi熱點, 使用者登入, 無線網路服務
>
> **頁面關聯：**
> WIDM lab 的 Wi-Fi登入通應用程式商店頁面與功能截圖
[Download WiFiPass (WiFi登入通) APP from Google Play](https://play.google.com/store/apps/details?id=com.project.twwifipass&hl=en)

![](https://sites.google.com/sitesv-images-rt/AMxu72tbXhcue5PxXXCdnkG3qzuXBNFb2Nrclh6EEuE15GPUcwFARjmtJqjK5Gr_PezNkXJ6MPORjLCacL-qxRiRtj9swSSObWWUvozrWihJud2qci2lc8l8WCPuV9za09t5vlkXz5DsG_QcxJqynQVs9n7h4ZYpbhPtkHEq4z3Q4_M3T4enR4y1_q9ss_ZdFZUU3e8ILeWBRw=w1280)
> # Image-2
>
> **圖片摘要：**
> Y5PASS 應用程式頁顯示圖示、名稱、WIDM lab、3+分級及解除安裝與開啟按鈕。
>
> **主要元素：**
> 1. 實體: 應用程式圖示, 應用程式資訊卡, 年齡分級標籤, 解除安裝按鈕, 開啟按鈕
> 2. OCR文字:
> 74%
> 21:42
> Y5PASS
...
> 解除安裝
> 開啟
> 3. 主題標籤: Y5PASS, Android, 應用程式管理, 應用程式資訊
>
> **頁面關聯：**
> Y5PASS 應用程式頁，WIDM lab，應用程式管理介面
