...
[Web Demonstration](https://eventgo.widm.csie.ncu.edu.tw/#/) [Download (Android)](https://play.google.com/store/apps/details?id=com.widmlab.eventgo&hl=zh_TW) [![https://play.google.com/store/apps/details?id=com.widmlab.eventgo&hl=zh_TW](https://lh3.googleusercontent.com/sitesv/AA5AbUAMdfFJ3U89sVnnFFeCCW2f18Xj9TQazIiIisArt-AkbbtHTI5lWhlMAaeAM0jm8D2yIEJtzFEcvo6MSCYsLd1KRHfh7kCSQvBo_dHwV-Mkkc1Hub4S_kaKYvowjieQO8LEfwz9ryt6CusQYcgWwNM_sg-X9V3_O4W-R-Zikvq1g7bH4CvvSlZl_cttSTlG6sCZaOsw=w1280)
> # Image-1
>
> **圖片摘要：**
> EventGO應用程式介面展示，包含應用圖示、地圖搜尋功能視圖與活動列表頁面，顯示定位搜尋與活動詳情內容。
>
> **主要元素：**
> 1. 實體: EventGO, WIDM lab, Google地圖, 手機應用程式, 活動列表
> 2. OCR文字:
> EventGO!
> WIDM lab 旅遊與地方資訊
> 3+
...
> 3. 主題標籤: 旅遊資訊, 行動應用程式, 活動查詢, 地理定位, EventGO
>
> **頁面關聯：**
> 圖片為EventGO應用程式之功能展示截圖，呈現WIDM lab開發的活動搜尋與導航服務。
