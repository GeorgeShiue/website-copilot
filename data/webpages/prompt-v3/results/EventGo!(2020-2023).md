...
[![https://play.google.com/store/apps/details?id=com.widmlab.eventgo&hl=zh_TW](https://lh3.googleusercontent.com/sitesv/AA5AbUBmdQ5bxYzt-l69T1nX4oR8Wfczmbr6GNVrw2ktMPjMPmw_B_5EGASUw50H-n87-87EbN7gu8rSG8MEGZbiStEak01ozr8xLzcbgbIx08PtKT0QhHKuFJ3AK1xxr_MEwakRlfuvrtkoDg7CxVJizmlMMkF2gK75h0fln0f4ChY-VE-gqn2zv0ZP0tTDNBE3zFqCD1BB=w1280)](https://play.google.com/store/apps/details?id=com.widmlab.eventgo&hl=zh_TW)
> # Image-1
>
> ## 圖片摘要
> EventGO!應用程式頁面包含應用程式圖示、活動地圖介面、活動列表介面及相關功能說明文字。
>
> ## 主要元素
> 1. 實體: EventGO!應用程式, WIDM lab, Google地圖, 活動列表, GPS定位功能
> 2. OCR文字:
> EventGO!
> WIDM lab 旅遊與地方資訊
> 3+
...
> 3. 主題標籤: 旅遊軟體, 行動應用程式, 活動資訊查詢, GPS定位, 導航系統
>
> ## 頁面關聯
> EventGO!應用程式頁面展示軟體功能介面與操作說明，屬於WIDM lab開發的活動搜尋服務。
