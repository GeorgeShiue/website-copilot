### DS4NER: Distant Supervision for Named Entity Recognition

**Introduction** DS4NER is a simple, customizable implementation of Distant Supervision for Named entity recognition. DS4NER is designed for preparing training data for Named Entity Recognition.
...
- [Installation](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
- [Getting started](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
- [Main Modules](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [File formats](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [Automatic labeling](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [Dictionary mining](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [Feature generation](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [Model training & testing with CRF++](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
  - [Data crawling](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
- [Release history and download](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
- [References](https://sites.google.com/site/nculab/projects/web-ner-tool/ds4ner)
...
**evaluation.cmd or evaluation.sh** This batch file uses the trained model "Corpus.model" in the "Corpus\\Training" directory and the test corpus "LabeledExtractorCorpus.txt" in the "Corpus\\Testing" directory as input. The output is shown in "WorkFolder\\Eva_Exact" and "WorkFolder\\Eva_Partial" directories, representing the performance evaluation in terms of exact match and partial match. Note that the batch also includes Pre-Processing, Feature Generation, CRF Testing. **File formats**

- The main input is a corpus with UTF=8 encoding, representing the corpus.
- Seed file: Every line is an entity.

王建民 林書豪 李安

- Corpus: Each line represents a sentence.

郭泓志、羅嘉仁也可能搶進最後名單，還有18歲超級新秀曾仁和等，都是重點討論人選。 猿隊甫給「小飛機」陳冠任一紙3年總值936萬元的合約，正好成為周思齊的最佳比較指標。
...
**Automatic labeling** Java –cp NER.jar PrepareData.AutoLabeling -strInput_S <Input Corpus> -strSeeds_S <Seed File> -strOutput_L <Output Corpus> -bFilterNegExamples True -bPreProcessing True
...
- Use "-strInput" or "-strSeeds" to change Corpus and names in the entity list.
...
**Dictionary mining** java -cp NER.jar PrepareData.MineDict -strInput_L <Labeled Corpus> -strMethod Supp -fThreshold 0.5f
...
**Feature generation** java -cp NER.jar PrepareData.GenFeature -strInput_L <Labeled Corpus> -strOutput_F <Labeled Matrix> -strType Training -bPreProcessing False
...
**Model training & testing with CRF++** java -cp NER.jar Training.CRF -strInput_F <Labeled Matrix> -strModel <Model Name>
...
**Data crawling** java -cp NER.jar Crawler.WebCrawler -strSeeds <Seed File> -strOutput <Output File>
...
- 2018-05-02: [DS4NER v1.00](https://drive.google.com/open?id=1ENKhjkxcf_hcGtUTZSPNDg4o4tU_Oo7B) Released
- 2018-06-03: [DS4NER v1.01](https://drive.google.com/open?id=12Vy-KckbVUaPaAu40CnvaP_dPAcUhUbL) Released
