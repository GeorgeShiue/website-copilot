...
![NCUFree Poster](https://lh3.googleusercontent.com/sitesv/AA5AbUCH8PDGkRQ9Ia03Gpko89EebPkcfhhqCaScchoUs4nDNTWvkJVJQXee_4JAlDkTIDl68z8-Im7CG_hgCKwTkQZK5ZUg59JlCzG5lzAytfR3DymHOV89oQVI7Bl1qn35ax7QrNAUwjNDkqlh35W_Jbo9iajTTrJ5-keB071oQaAV8VdAwH6wvIeEAthlfcuNp7v2Fg=w1280)
> # Image-1
>
> **圖片摘要：**
> NCUFree 無線網路宣傳海報，提供 Android 與 iOS 系統的 App 下載 QR Code 及登入說明。
>
> **主要元素：**
> 1. 實體: NCUFree, 無線網路, QR Code, Android APP, iOS APP
> 2. OCR文字:
> NCUFree
> 中大校園走透透......
> 免費無線網路
...
> Wi Fi
> 3. 主題標籤: 國立中央大學, 無線網路服務, NCUFree, 校園資訊系統, 行動應用
>
> **頁面關聯：**
> 本圖為國立中央大學 NCUFree 無線網路服務之宣傳指引。
...
![](https://lh3.googleusercontent.com/sitesv/AA5AbUBl4J883fOqfEoDFvSHQHBjShA0wAT5GfeBukqGLQxcct0L35IDo8mr5ga9WY0le-QIx1ZuUEiZBR5wNU-uCMmXzxfe3ViWzm6s_jjOSVmPbtaPnblYkOuHd6wy343KD-_Y3mRzqyxgYLMRiBAxR4MwykIZ=w1280)
> # Image-2
>
> **圖片摘要：**
> Google Play 標誌位於黑色圓角矩形圖示上方，下方排列品牌文字。
>
> **主要元素：**
> 1. 實體: Google Play 標誌, 應用程式圖示
> 2. OCR文字:
> ANDROID APP ON
> Google play
> 3. 主題標籤: Android, Google Play, 軟體發行平台, 行動應用程式
>
> **頁面關聯：**
> 本圖為 Google Play 平台識別標章，用於連結應用程式下載頁面。
[![](https://lh3.googleusercontent.com/sitesv/AA5AbUB1-tsycDw33u0KEr6B4xHZ-3z84tJH6UNeFZGJ5LKmuVAroyDQ_02SosvCQPfqzoNfy8GvJOqWbHmyb8BuXouw5TXWxiTs6vjWzzRADmQo38S6SuGnWxbw4X6eMC7sdaVwCI6pIPdse79vztalQaFQAYxo=w1280)
> # Image-3
>
> **圖片摘要：**
> Apple 標誌位於上方，下方為 Available on the App Store 文字，置於圓角矩形框內。
>
> **主要元素：**
> 1. 實體: Apple 標誌, App Store
> 2. OCR文字:
> Available on the
> App Store
> 3. 主題標籤: Apple, App Store, 行動應用程式, iOS, 軟體發行
>
> **頁面關聯：**
> 本圖為 App Store 下載連結錨點，歸屬於 Apple 軟體生態系統。
