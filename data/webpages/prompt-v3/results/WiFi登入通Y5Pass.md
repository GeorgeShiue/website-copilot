...
![](https://lh3.googleusercontent.com/sitesv/AA5AbUA99WP8x1OpXvgoZ3ScOfyeqRjaS_s1L9kFEMCH_AiVTSrLfd8syAzMqT0KoeLAWpubsGe-xo5UrPG-Q072E1eNYv5g6ne4znACRnj4zh-vYewyl1enrWwSOcXORbEYTomhJLQZzVH3XnCCRVdbM6LclUi3nFp7DjlgAuXM-uZ-lPLJyUH65jjCCJceq7FMY_Arzn5J=w1280)
> # Image-1
>
> **圖片摘要：**
> Android 應用程式商店頁面顯示 Wi-Fi 登入通 App 的圖示、安裝按鈕及三張顯示網路連線狀態與中央大學無線網路服務介面的手機螢幕截圖。
>
> **主要元素：**
> 1. 實體: Wi-Fi 登入通, WIDM lab, Android App, 中央大學無線網路服務, 應用程式商店
> 2. OCR文字:
> Wi-Fi登入通 (Wi-Fi Pass)
> WIDM lab Tools
> 22
...
> User Login
> username
> 3. 主題標籤: 網路工具, 校園無線網路, Android應用程式, 中央大學, Wi-Fi認證
>
> **頁面關聯：**
> 本頁面為 Google Play 商店的 Wi-Fi 登入通應用程式詳情頁，提供中央大學無線網路存取功能。
[Download WiFiPass (WiFi登入通) APP from Google Play](https://play.google.com/store/apps/details?id=com.project.twwifipass&hl=en)

![](https://lh3.googleusercontent.com/sitesv/AA5AbUAKXZXQnNQgpRbIDnXKyVZxQBls7xtok2Q2XUoKebBGGRuaD7Bz-LNVhZaiD4LeYy6O03OgG_OItBwaaOYgNrS-Gig33emLK3_i8TEobcH5pNLpua1XL8qAyukp5okCm7xeqM7V5E8F69gZhd4dRd2L1QN_pH2nCnEMaqR1MJoULuTRY6V5ApgRI1b-Cc84x2dbmA=w1280)
> # Image-2
>
> **圖片摘要：**
> Y5PASS 應用程式介面顯示產品圖示、開發者名稱 WIDM lab 與解除安裝及開啟按鈕。
>
> **主要元素：**
> 1. 實體: Y5PASS, WIDM lab, 解除安裝按鈕, 開啟按鈕
> 2. OCR文字:
> Y5PASS
> Y5PASS
> WIDM lab
...
> 解除安裝
> 開啟
> 3. 主題標籤: Android 應用程式, 軟體管理
>
> **頁面關聯：**
> 本圖為 Google Play 商店 Y5PASS 應用程式頁面，屬 WIDM lab 開發之產品。
