...
![](https://lh3.googleusercontent.com/sitesv/AA5AbUCWbop61wvJ9O_WVQcQ5YDqZAzIgyeMbtqvT7sdj3JbBA5blAY_C4XlNcCoxPT-s3j8UDKJhwohWNkSOvF8nmFyDmCXn4k6X0FpYDnKcVOlyLEpKPKu6SZIzHp6cIH5gRBAvAxjl432_7AjrwxMFXWMy1VyWribyUzSJxibz1fuY9SEKi9QBOQce9cocWJFhjfNS9SY=w1280)
> # Image-1
>
> **圖片摘要：**
> Wi-Fi登入通應用程式商店頁面，上方展示應用圖示、名稱與安裝按鈕，下方並排顯示三張顯示無線網路連線與使用者登入介面的手機截圖。
>
> **主要元素：**
> 1. 實體: Wi-Fi登入通, WIDM lab, 應用程式商店, 安卓機器人圖示, 無線網路服務
> 2. OCR文字:
> Wi-Fi登入通 (Wi-Fi Pass)
> WIDM lab Tools
> 22
...
> User Login
> username
> 3. 主題標籤: Android應用程式, Wi-Fi網路工具, 網路連線管理, 中央大學, 軟體發布平台
>
> **頁面關聯：**
> 本頁為Google Play商店中Wi-Fi登入通應用程式介紹頁，包含開發者WIDM lab資訊及軟體功能截圖。
[Download WiFiPass (WiFi登入通) APP from Google Play](https://play.google.com/store/apps/details?id=com.project.twwifipass&hl=en)

![](https://lh3.googleusercontent.com/sitesv/AA5AbUBebGvjhmfnD6MT46AFfjcvD0w3FIvCEfp0oIwkY0OKUtSmYyjB44QLdxoUtNEp1D7LfFLGd1hlIslA9ufMsMfBbD-BCF3gJsd5ouGpm4Nvkapm7IkSFqyUj2ZYH0oMJDz1-QAhrWX7nBq9xxl58YZMJw5N57SUnPs7bSxDKcs3E8WEOAJhM226DVDVIO6iK-Q3bA=w1280)
> # Image-2
>
> **圖片摘要：**
> Y5PASS 應用程式介面顯示藍色圖標與軟體名稱，下方並列解除安裝與開啟按鈕。
>
> **主要元素：**
> 1. 實體: Y5PASS, WIDM lab, 應用程式圖標, 解除安裝按鈕, 開啟按鈕
> 2. OCR文字:
> Y5PASS
> Y5PASS
> WIDM lab
...
> 解除安裝
> 開啟
> 3. 主題標籤: Android應用程式, 軟體管理, Y5PASS
>
> **頁面關聯：**
> 本圖為 Google Play 商店的 Y5PASS 產品頁面，開發者為 WIDM lab。
